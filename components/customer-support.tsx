    ...
    <section className="max-w-[1230px] mx-auto text-white p-2 md:p-0">
      <div className="my-2 md:mt-10">
        <h2 className="font-[900] text-lg md:text-xl lg:text-2xl">
          Customer Services of Panalobet: Always Here to Support
        </h2>
        <div className="flex items-center flex-col-reverse gap-2 md:flex-row">
          ...
          <div className="w-full md:w-[50%] flex items-center justify-center md:w-[400px] md:h-[400px] md:ml-24 md:rounded-md">
            <Image
              src="/img/Support/Customer Services of Panalobet.webp"
              width={400}
              height={400}
