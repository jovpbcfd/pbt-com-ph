    ...
    <section className="max-w-[1230px] mx-auto text-white p-2 md:p-0">
      <div className="my-2 md:mb-4 md:mt-5">
        ...
        <div>
          ...
          <p className="mb-2 md:my-4">
            Usually, fishing games revolve on the concept of aiming and shooting
            a fishing line to capture different kinds of fish. Using a virtual
            fishing rod or line, players have to target the fish in the game by
            controlling direction, force, and speed. Every kind of fish has
            value; rarer species are especially valuable and hence widely sought
            for.
          </p>
          <p className="mb-2 md:my-4">
            Usually beginning with a bet, players' choices and the particular
            game will affect how much they stake. Players can start targeting
            their fishing line at the fish on the screen once the bet is laid.
            The difficulty is timing the line exactly to land the catch and
            properly shooting the line at the fish. Effective captures pay off;
            the worth of the fish caught determines the wager paid and so
        ...
        <div>
          ...
          <p className="mb-2 md:my-4">
            ...
            with the best payback. Fish are classified in most games depending
            on their rarity and degree of difficulty. While rare or legendary
            fish can pay significantly more, common fish may be more easy to
            catch yet give less earnings. Players who wish to enhance their
            chances of huge win must first understand the values and actions of
            various fish.
          </p>
        </div>
        <div>
