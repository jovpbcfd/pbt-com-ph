    ...
    return (
        <section className="max-w-[1230px] mx-auto text-white p-2 md:p-0">
            <div className="md:mt-5">
                <h2 className="font-[900] text-lg md:text-xl lg:text-2xl">Detailed Step-by-Step Guide on Joining Panalobet Casino</h2>
                <p className="mb-2 md:mb-4">
                    Joining Panalobet Casino lets you start playing your preferred games in no time by a simple and fast approach. Here is a thorough,
                    exact tutorial on how to register for your account and savor the fascinating universe of online gaming.
                </p>
                            ...
                            >
                                <div className="self-center relative">
                                    <div
                                        className={cn(
                                            ...
                                            activeStep === step.id ? "bg-[#3659E7] text-white border-[#3659E7]" : "bg-[#3659E7]/90 text-white/90"
                                        )}
                                    >
                                        {step.id}
                                    </div>
                                ...
                                <div className="flex w-full flex-col md:flex-row md:gap-4">
                                    <div className="self-center md:w-[50%]">
                                        <h3 className="text-md uppercase font-bold text-center md:text-left md:font-[800] md:text-xl">{step.title}</h3>
                                        <p className="text-justify md:mt-4">{step.description}</p>
                                    </div>
                                    <div className="border-1 border-dashed flex items-center justify-center rounded-md md:w-[600px] md:h-[460px]">
                                        Image
                                    </div>
                                </div>
                                {activeStep === step.id && (
