export const withdrawals = [
    {
        id: 1, title: "Choose Your Suggested Withdrawal Strategy", description: `
...
` }
    ...
    {
        id: 2, title: "Enter Withdrawal Information", description: `You will have to enter the necessary information once you have chosen your desired withdrawal method. This covers the amount you want to withdraw as well as, depending on your preferred approach, the required account information—bank account details, wallet addresses, or any other pertinent identification data.
        Making sure all the data is accurate will help to prevent any possible delays or problems with your withdrawal.
        ` },
    {
        id: 3, title: "Ask for a Withdrawal", description: `Enter the required information then use the on-screen directions to submit your withdrawal request. Once sent in, Panalobet's system will start handling your request. Remember that every withdrawal technique processes things differently:`,
        subList: [
