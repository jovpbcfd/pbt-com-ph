export const deposits = [
    {
        id: 1, title: "Select the Payment Method You Want", description: `
...
` },
    ...
    {
        id: 2, title: "Add the Deposit Amount", description: `Entering the amount you intend to deposit comes next once you have selected your payment option. Panalobet lets you vary the amount you can deposit, so you can start with a budget fit for your circumstances. Double-checking the amount you input helps you to guarantee accuracy since mistakes could create processing delays for your transaction.
        ` },
    {
        id: 3, title: "Execute On-screen Directions", description: `Every payment type will have unique directions for finishing your deposit. The screen will prominently show these directions to help you along the way. Certain techniques could call for extra verification processes, such as validating the transaction via a safe payment gateway or inputting a one-time code texted to your phone. Once you have followed all the guidelines, just make a deposit request.`,
    },
    {
        id: 4, title: "Quickly Enjoy Your Money", description: `Your Panalobet account should show the money virtually right away when you have finished your deposit. This allows you to play a great range of casino games, sports betting, and more straightforwardly into the action. Panalobet works to guarantee quick processing of deposits so you may spend more time playing and less time waiting.`
    }
];