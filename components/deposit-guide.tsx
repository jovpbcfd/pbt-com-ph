    ...
    <section className="max-w-[1230px] mx-auto text-white p-2 md:p-0">
      <div className="md:mt-10">
        ...
        <p className="my-2 md:my-4">
          Simple and rapid fund depositing into your Panalobet account lets you
          start immediately playing your preferred casino games or sports
          betting options. Use the instructions below to safely and securely
          deposit money.
        </p>
